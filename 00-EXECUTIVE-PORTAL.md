...
### 1) 🟣 Legal Foundation
- SPV formation and bankruptcy-remoteness: `legal/01-SPV-Formation-Guide.md`
- Board authority: `legal/02-Board-Resolution-Template.md`
- Asset contribution: `legal/03-Asset-Contribution-Agreement-Template.md`
- Risk register: `legal/04-Risk-Register.md`
- IOU terms (`ALXUSD`): `legal/05-IOU-Terms-ALXUSD.md`
- Redemption policy: `legal/06-Redemption-Policy-ALXUSD.md`
- No-lien template: `legal/07-No-Lien-No-Encumbrance-Template.md`

### 2) 🟠 Custody + Insurance
- Vault selection criteria: `custody/01-Vault-Selection-Criteria.md`
- Chain-of-custody log: `custody/02-Chain-of-Custody-Template.md`
- Insurance requirements: `custody/03-Insurance-Requirements.md`
- Vault RFP checklist: `custody/04-Vault-RFP-Checklist.md`
- Custodian intro pack: `custody/05-Custodian-Intro-Pack.md`

### 3) 🔵 Asset Verification (Cryptographic)
- Appraisal hash record: `asset/01-Appraisal-Hash.md`
- IPFS upload record: `asset/02-IPFS-Upload-Record.md`
- Committee-ready MAR: `asset/03-Master-Asset-Record.md`
- Detailed MAR (narrative): `asset/01-Master-Asset-Record.md`

### 4) 🟢 XRPL Canonical Program
- High-level digital twin architecture: `onchain/01-XRPL-Digital-Twin-Spec.md`
- Issuer account spec: `xrpl/01-Issuer-Account-Spec.md`
- Currency definition: `xrpl/02-Currency-Definition-ALXUSD.md`
- Trustline policy: `xrpl/03-Trustline-Policy.md`
- Issuance flow: `xrpl/04-Issuance-Flow.md`
- Memo schema (canonical evidence payload): `xrpl/05-Memo-Schema.md`
- Freeze/clawback policy: `xrpl/06-Freeze-Clawback-Policy.md`
- XRPL attestation tx template (ready-to-submit): `xrpl/07-Attestation-Transaction-Template.md`

### 5) 🟦 Stellar Mirror (Optional)
- Stellar mirror spec: `onchain/02-Stellar-Mirror-Spec.md`
- XRPL primary + parity rules: `tokenization/02-XRPL-Primary-Stellar-Mirror.md`

### 6) 🟡 Finance
- Credit facility term sheet: `finance/01-Credit-Facility-Term-Sheet.md`
- LTV model: `finance/01-LTV-Model.md`
- Facility structure narrative: `finance/02-Credit-Facility-Structure.md`
- Use-of-proceeds policy: `finance/03-Funding-Use-Cases.md`

### 7) ⚫ Ops (Operating System)
- IOU program runbook: `ops/01-IOU-Program-Runbook.md`
- Funding playbook: `ops/02-Funding-Playbook.md`
- First lender outreach email: `ops/03-First-Lender-Outreach-Email.md`
- Diligence packet index: `ops/04-Diligence-Packet-Index.md`

### 8) Diagrams
- System architecture: `diagrams/01-System-Architecture.md`
- Fund flow: `diagrams/02-Fund-Flow.md`
- Trust boundaries: `diagrams/03-Trust-Boundaries.md`
- **New overview pack (color-coded):** `diagrams/00-Color-Coded-Overview.md`
